...
import com.example.project.db.repository.DiaryCountRepository;
import com.example.project.db.repository.DiaryRepository;
import com.example.project.db.repository.RecentDiaryRepository;
...
public class DiaryServiceImpl implements DiaryService {
    ...
    @Override
    public Optional<Long> insertDiary(Long userId, DiaryReq diaryReq) {
    ...
    @Override
    public Optional<DiaryResp> selectOneDiary(Long diaryId) {
        Optional<Diary> diary = diaryRepository.findById(diaryId);
        return diary.map(this::toResponseDto);
    }

    public List<DiaryResp> selectAllDailyDiary(Long userId, String stringDate) {
        Optional<User> optionalUser = userRepository.findById(userId);
        if (optionalUser.isEmpty()) {
            return null;
        }
    ...
    public boolean deleteDiary(Long userId, Long diaryId) {
        Optional<DiaryResp> diaryResponseDto = selectOneDiary(diaryId);
