...
import com.example.project.db.repository.ReviewRepository;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    // 댓글 입력
    @Override
    public void insertReview(Long userId, ReviewReq reviewDto) {
    ...
    // 댓글 가져오기
    @Override
    public List<ReviewResp> selectAllReview(Long userId, Long diaryId) {
